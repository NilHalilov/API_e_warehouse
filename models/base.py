"""Модуль для создания: базового класса для моделей БД и асинхронного подключения к БД"""
...
e_store_db = DBConnect(url=settings_db.db_url, echo=settings_db.db_echo)
